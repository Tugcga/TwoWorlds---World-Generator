...
#if UNITY_EDITOR
public class LWRP_SimpleLit_Lightmap_UI : BaseShaderGUI
{
    // Properties
    private SimpleLitGUI.SimpleLitProperties shadingModelProperties;
    public MaterialProperty lightMapProp;
    ...
    public override void DrawSurfaceInputs(Material material)
    {
        ...
        materialEditor.TexturePropertySingleLine(new GUIContent("LightMap"), lightMapProp);
    }
