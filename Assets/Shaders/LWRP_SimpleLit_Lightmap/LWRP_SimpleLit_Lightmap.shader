Shader "Lightweight Render Pipeline/Simple Lit With Lightmap"
{
    Properties
    {
		...
		SubShader
		{
			...
			Pass
			{
				...
				//#pragma multi_compile _ _MIXED_LIGHTING_SUBTRACTIVE  // <-- disable mixing

				// -------------------------------------
				// Unity defined keywords
				#pragma multi_compile _ DIRLIGHTMAP_COMBINED
				//#pragma multi_compile _ LIGHTMAP_ON  // <-- turn off using build-in lightmaps
				...
				#include "LWRP_SimpleLitInput_Lightmap.hlsl"
				#include "LWRP_SimpleLit_Lightmap_ForwardPass.hlsl"
				ENDHLSL
			}
		...
		CustomEditor "LWRP_SimpleLit_Lightmap_UI"
